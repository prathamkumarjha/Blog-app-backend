...
urlpatterns = [
   ...
   #Posts
    ...
    path('web/posts/search/', BlogPostSearchView.as_view(), name='blogpost-by-title'), #for getting blog post according to its title will be used in search bar 
    path('web/posts/<pk>/increaseClaps/',IncreaseClapsView.as_view(),name='increase-blogpost-like'),
    #Admin Posts
    #Auth
